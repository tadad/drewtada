...
export default function Journal() {
  return (
    <Layout>
      ...
      <JournalPost date="5-16-21" title="Death of the Author is a Theory for Midwits">
        <p>
        ...
        <img src="/bosch.jpeg" />
        <p>
          Let me explore this in the context of meme culture, something all can understand.
        </p>
        <p>
        ...
        <p>
          ...
          art with no inherent meaning. All "merely aesthetic" experiences are open to interpretation. Everyone sees something
          different when they do drugs - same with trashy art. But my memes are different. Bosch is different. There is meaning in them,
          but the unwashed masses aren't allowed to know.
        </p>
      </JournalPost>
      ...
      <JournalPost date="5-14-21" title="Culture: Atoms vs Bits">
        <p>
          Both Peter Thiel and Bruno Maçães talk about the pivot from atoms to bits in the early 70s. Thiel's famous quote is&nbsp;
          <a href="https://www.evernote.com/shard/s542/client/snv?noteGuid=46c636b6-b404-45df-ab0a-1f84c6fdc8c2&noteKey=7c94233539b8258d72b395a063f3c589&sn=https://www.evernote.com/shard/s542/sh/46c636b6-b404-45df-ab0a-1f84c6fdc8c2/7c94233539b8258d72b395a063f3c589&title=That+Essay">
            we wanted flying cars, and all we got was 140 characters,
          </a>"
          a declaration of our failure to realize the sci-fi future. We (may) have the Star-Trek
          computer, but we have no warp drive, no space travel, our lifespans are decreasing, and we lack energy and food needed
          to reach escape velocity. The digital revolution continues, but innovation has failed very miserably in the world of atoms.
          </p>
          <p>
          Maçães has a similar claim, but in the domain of politics. He says&nbsp;
            <a href="https://www.thepullrequest.com/p/american-magical-realism">
              America is one giant theme park.
            </a>
          &nbsp;Our political culture is entirely fake. There are no Nazis, nor any communist
          revolutionaries. "In a capitalist world, violent debates about truth interefere with the productive act of commerce."
          There is no war, no thrilling adventure, no threat to our existence - and yet we are consumed by media
          that makes us live as though this is true. Maybe it's a sitcom, or maybe a reality TV show, or maybe the WWE, or maybe
          a disaster movie - but it is not reality - it is virtual reality. No one takes real risk in America -
          we are far too cowardly. 
          </p>
          <img src="/thiel.jpeg" />
          <p>
          To these two points, I would like to add that our art and cultural
          production are also all entirely virutal. Any art that requires a physical presence to be experienced - a painting 
          in a gallery, a sculpture in a garden, or a building downtown - is dead. It seems that we still have great movies every 
          once in a while, great music and videogames too - but when was the last 
          time we collectively venerated a painting? A sculputre? A beautiful new building? It simply doesn't happen anymore.
          Atoms are dead. We have collectively decided that bits are the future in politics, technology, and culture - though
          this seems to have come at the price of self-stultification: a decrease in our ambition, ability, and aspiration
